...
public class CheapSoundFile {
    ...
    public void WriteFile(File outputFile, int startFrame, int numFrames, boolean fadeIn, boolean fadeOut, int fadeTime)
        ...
        if (this instanceof CheapAAC) {
            CheapAAC cheap = (CheapAAC) this;
            cheap.WriteFile(outputFile, startFrame, numFrames, fadeIn, fadeOut, fadeTime);
        } else if (this instanceof CheapAMR) {
            CheapAMR cheap = (CheapAMR) this;
            cheap.WriteFile(outputFile, startFrame, numFrames, fadeIn, fadeOut, fadeTime);
        } else if (this instanceof CheapMP3) {
            CheapMP3 cheap = (CheapMP3) this;
            cheap.WriteFile(outputFile, startFrame, numFrames, fadeIn, fadeOut, fadeTime);
        } else if (this instanceof CheapWAV) {
            CheapWAV cheap = (CheapWAV) this;
            cheap.WriteFile(outputFile, startFrame, numFrames);
        }
    }
