...
public class CheapAMR extends CheapSoundFile {
    ...
    private void parseAMR(InputStream stream, int maxLen)
            throws java.io.IOException {
    ...
    private int parseAMRFrame(InputStream stream, int maxLen, int[] prevEner)
            throws java.io.IOException {
    ...
    private void addFrame(int offset, int frameSize, int gain) {
    ...
    private void getMR122Params(int[] bits,
                                int[] adaptiveIndex,
                                int[] adaptiveGain,
                                int[] fixedGain,
                                int[][] pulse) {
    ...
    public void WriteFile(File outputFile, int startFrame, int numFrames, boolean fadeIn, boolean fadeOut, int fadeTime)
        ...
        in.close();
        out.close();
        Log.v("WriteFile", "CheapAMR");
    }

    // Block size in bytes for each of the 16 frame types, notification_ic
    // counting the initial byte that indicates the frame type.
    // Can be used to skip over unsupported frame types.
    static private final int[] BLOCK_SIZES = {
            12, 13, 15, 17, 19, 20, 26, 31,
            5, 0, 0, 0, 0, 0, 0, 0};

    static private final int[] GAIN_FAC_MR515 = {
    ...
    static private final int[] QUA_ENER_MR515 = {
    ...
    static private final int[] QUA_GAIN_CODE = {
    ...
    static private final int[] GAIN_FAC_MR475 = {
    ...
    static private final int[] GRAY = {0, 1, 3, 2, 5, 6, 4, 7};

    static private final int[] QUA_GAIN_PITCH = {
